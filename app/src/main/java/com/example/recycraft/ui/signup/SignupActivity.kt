...
class SignupActivity : AppCompatActivity(),View.OnClickListener {
            ...
            override fun onResponse(
                ...
                if(response.isSuccessful){
                    ...
                    try {
                        ...
                        Toast.makeText(this@SignupActivity,jObjError.getString("message"), Toast.LENGTH_LONG).show()
                    }catch (e:Exception){
    ...
    private fun validateCreateAccount(): Boolean {
        return if(binding.emailInput.text!!.isNotEmpty() && binding.passInput.text!!.isNotEmpty() && binding.nameInput.text.isNotEmpty()
            && android.util.Patterns.EMAIL_ADDRESS.matcher(binding.nameInput.text.toString()).matches()
